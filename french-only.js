(() => {
  ...
  function clean(value){
    ...
    let out=value.replace(/（[^）]*[\u3400-\u9fff][^）]*）/g,'').replace(/\([^)]*[\u3400-\u9fff][^)]*\)/g,'');
    out=out.replace(/(?:——|--|:|:) *[^\n]*[\u3400-\u9fff][^\n]*/g,'');
